...
public enum OperatorType {
    ...
    OperatorType(TokenType tokenType, int precedence, Associativity associativity, String name) {
        this(tokenType, precedence, associativity, false, name);
    }

    OperatorType(TokenType tokenType, int precedence, Associativity associativity, boolean isUnary, String name) {
